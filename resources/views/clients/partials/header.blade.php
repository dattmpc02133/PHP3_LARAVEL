		...
		<div class="container-menu-desktop">
			...
			<div class="top-bar">
				<div class="content-topbar flex-sb-m h-full container">
					<div class="left-top-bar center">
						Giao hàng miễn phí cho đơn đặt hàng tiêu chuẩn trên 3.000.000đ
					</div>
				...
				<nav class="limiter-menu-desktop container ">
					...
					<div class="menu-desktop">
						<ul class="main-menu">
							...
							<li>
								<a href="{{url('/blog')}}">Tin tức</a>
							</li>

							<li>
								<a href="{{url('/about')}}">Giới thiệu</a>
							</li>

							<li>
								<a href="{{url('/contact')}}">Liên hệ</a>
							</li>
						</ul>
					</div>	
			...
			<div class="header-cart-content flex-w js-pscroll">
				<ul class="header-cart-wrapitem w-full">
					<li class="header-cart-item flex-w flex-t m-b-12">
						...
						<div class="header-cart-item-close">
							<i class="zmdi zmdi-close"></i>
						</div>
					</li>
	...
	<section class="section-slide">
		<div class="wrap-slick1">
			<div class="slick1">
				<div class="item-slick1" style="background-image: url(https://file.hstatic.net/200000312481/file/dsc05692_39baebe1403c487581b4cd9a39354736.jpg">
